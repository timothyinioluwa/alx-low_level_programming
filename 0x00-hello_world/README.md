...
Example: if the C file is main.c, the output file should be main.o julien@ubuntu:/c/0x00$ export CFILE=main.c julien@ubuntu:/c/0x00$ cat main.c #include <stdio.h>
